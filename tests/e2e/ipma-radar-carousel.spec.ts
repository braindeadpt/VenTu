...
// O mapa de logística da página de spot é deliberadamente mínimo (sem radar
// nem camadas): a cobertura do carrossel IPMA vive nos describes de
// grid/hero/fullscreen acima e abaixo.
