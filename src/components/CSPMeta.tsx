...
const CSP_META = {
  ...
  fontSrc: "'self' data:",
  imgSrc: "'self' data: blob: https://*.tile.openstreetmap.org https://*.basemaps.cartocdn.com https://server.arcgisonline.com https://*.supabase.co https://ows.emodnet-bathymetry.eu",
