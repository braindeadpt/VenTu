/** Classes Tailwind partilhadas pelos três cartões de instrumento. */
...
export const INST_SUB =
  'text-[13px] text-[color:var(--vi-m)] transition-colors duration-200 motion-reduce:transition-none';
