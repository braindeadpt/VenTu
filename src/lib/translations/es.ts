...
export const translationsEs = {
  ...
  news: {
    ...
    emptyTitle: 'Aún sin noticias',
    emptyDescription:
      'El feed está vacío por ahora. Las noticias se actualizan automáticamente vía RSS — vuelve más tarde.',
    emptyFilterTitle: 'Ninguna noticia con este filtro',
