...
export const translationsEs = {
  ...
  hero: {
    ...
    firingNowEmpty: 'Ningún deporte a tope ahora mismo',
    firingNowSub: 'Solo spots a tope · por deporte',
    filterBySport: 'Filtrar por deporte',
    interactiveMap: 'Mapa interactivo',
    liveMap: 'Mapa en directo',
    viewForecasts: 'Ver previsiones',
    updatedAgo: 'Actualizado hace {hours}h',
    heroHeadline: '¿Dónde está bueno hoy?',
  ...
  spots: {
    ...
    bodyboard: 'Bodyboard',
    sup: 'SUP',
    metaTitle: 'Todos los Spots — VenTu',
    metaDescription: 'Explora los {count} spots de surf, kitesurf y windsurf en Portugal — condiciones {schedule}.',
    pageTitle: 'Todos los Spots',
    pageSubtitle: '{count} spots en Portugal — datos {schedule}',
  },
  conditions: {
  ...
  map: {
    ...
    mapUnavailableHint: 'Fallaron los tiles del mapa base. Puedes reintentar o ver la lista de spots.',
    viewSpotsList: 'Ver la lista de spots',
    spotsMapAria: 'Mapa de spots',
    fullscreenMapAria: 'Mapa a pantalla completa',
    metaTitle: 'Mapa de spots — VenTu',
    metaDescription: 'Mapa interactivo con {count} spots en Portugal — filtros por deporte, región y score.',
  ...
  home: {
    trustAria: 'Prueba social',
    trustSports: 'deportes',
    trustForecast: 'Previsión: 2h día · 4h noche',
    trustOpenSource: 'MIT · Open source',
    moreToExplore: 'Más para explorar',
    moreToExploreSub: 'Herramientas para planificar la próxima sesión',
    seasonalityTitle: 'Estacionalidad',
    seasonalityBody: 'Cuándo ir a cada spot — viento y olas por mes',
    compareTitle: 'Comparar spots',
    compareBody: 'Lado a lado, mismo timeframe',
    favoritesTitle: 'Favoritos',
    favoritesBody: 'Sincroniza spots y activa alertas por email',
  },
  common: {
    loading: 'Cargando...',
