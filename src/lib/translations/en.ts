...
export const translationsEn = {
  ...
  hero: {
    ...
    firingNowEmpty: 'No sports firing right now',
    firingNowSub: 'Only firing spots · by sport',
    filterBySport: 'Filter by sport',
    interactiveMap: 'Interactive map',
    liveMap: 'Live map',
    viewForecasts: 'View forecasts',
    updatedAgo: 'Updated {hours}h ago',
    heroHeadline: "Where's it firing today?",
  ...
  spots: {
    ...
    bodyboard: 'Bodyboard',
    sup: 'SUP',
    metaTitle: 'All Spots — VenTu',
    metaDescription: 'Browse all {count} surf, kitesurf and windsurf spots in Portugal — conditions {schedule}.',
    pageTitle: 'All Spots',
    pageSubtitle: '{count} spots in Portugal — data {schedule}',
  },
  conditions: {
  ...
  map: {
    ...
    mapUnavailableHint: 'Basemap tiles failed. Try again, or browse the spots list.',
    viewSpotsList: 'View spots list',
    spotsMapAria: 'Spots map',
    fullscreenMapAria: 'Fullscreen map',
    metaTitle: 'Spots map — VenTu',
    metaDescription: 'Interactive map of {count} spots in Portugal — filter by sport, region and score.',
  ...
  home: {
    ...
    trustSports: 'sports',
    trustForecast: 'Forecast: 2h day · 4h night',
    trustOpenSource: 'MIT · Open source',
    moreToExplore: 'More to explore',
    moreToExploreSub: 'Tools to plan your next session',
    seasonalityTitle: 'Seasonality',
    seasonalityBody: 'When to go to each spot — wind and waves by month',
    compareTitle: 'Compare spots',
    compareBody: 'Side by side, same timeframe',
    favoritesTitle: 'Favorites',
    favoritesBody: 'Sync spots and enable email alerts',
  },
