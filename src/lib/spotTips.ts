...
export const localTips: SpotLocalTips[] = [
  ...
  {
    spotSlug: 'troia',
    bestTide: 'Maré média no estuário — mais água plana',
    bestTideEn: 'Mid tide in the estuary — more flat water',
    parking: 'Ferry Setúbal–Tróia ou estrada pela Comporta. Parques no Bico das Lulas.',
    parkingEn: 'Setúbal–Troia ferry or road via Comporta. Parking at Bico das Lulas.',
    food: 'Restaurantes no resort; Comporta a 15 min.',
    foodEn: 'Resort restaurants; Comporta 15 min away.',
    accommodation: 'Resort Tróia, Comporta ou Setúbal — combina com lagoa de Albufeira no mesmo kitetrip.',
    accommodationEn: 'Troia resort, Comporta or Setúbal — pairs with Albufeira lagoon on the same kitetrip.',
    localRule: 'S/SW é o vento mais estável; Nortada pode ser gusty no Sado.',
    localRuleEn: 'S/SW is the most stable wind; Nortada can be gusty on the Sado.',
  },
  {
    spotSlug: 'comporta',
    bestTide: 'Qualquer maré',
    bestTideEn: 'Any tide',
    parking: 'Acesso por pinhal sinalizado; estacionamento na areia em época baixa.',
    parkingEn: 'Access via signed pine road; sand parking in off-season.',
    food: 'Comporta Café e restaurantes na vila.',
    foodEn: 'Comporta Café and village restaurants.',
    accommodation: 'Comporta e Carvalhal — alojamento disperso no pinhal.',
    accommodationEn: 'Comporta and Carvalhal — scattered lodging in the pines.',
    localRule: 'Light-wind spot — foil ou equipamento grande nos dias fracos.',
    localRuleEn: 'Light-wind spot — foil or big gear on weak days.',
  },
  {
    spotSlug: 'fonte-telha',
    bestTide: 'Maré média-alta',
    bestTideEn: 'Mid-high tide',
    parking: 'Parque junto à praia; chega cedo aos sábados de Nortada.',
    parkingEn: 'Lot by the beach; arrive early on Nortada Saturdays.',
    food: 'Bares na marginal; Almada a 15 min.',
    foodEn: 'Waterfront bars; Almada 15 min.',
    localRule: 'Menos crowd que CDS — respeita banhistas no verão.',
    localRuleEn: 'Less crowded than CDS — respect swimmers in summer.',
  },
  {
    spotSlug: 'esposende',
    bestTide: 'Maré média na lagoa — barco das escolas na maré baixa',
    bestTideEn: 'Mid tide in the lagoon — school boat shuttles at low tide',
    parking: 'Parque junto ao cais do Cávado.',
    parkingEn: 'Lot by the Cavado pier.',
    food: 'Restaurantes na marginal de Esposende.',
    foodEn: 'Restaurants on Esposende waterfront.',
    accommodation: 'Esposende e Ofir — base para kite norte (Ofir, Viana).',
    accommodationEn: 'Esposende and Ofir — base for northern kite (Ofir, Viana).',
    localRule: 'Crowd de kite concentrada na lagoa — praia oceano (esposende-praia) em dias de swell.',
    localRuleEn: 'Kite crowd concentrates on the lagoon — ocean beach (esposende-praia) on swell days.',
  },
  {
...
export const blueFlagBeaches: Record<string, { year: number; waterQuality: 'excelente' | 'boa' | 'razoavel' | 'má' }> = {
  ...
  'comporta': { year: 2025, waterQuality: 'excelente' },
  'carvalhal-comporta': { year: 2025, waterQuality: 'excelente' },
  'ponta-dos-corvos': { year: 2025, waterQuality: 'boa' },
  'trafaria': { year: 2025, waterQuality: 'boa' },
  'cova-do-vapor': { year: 2025, waterQuality: 'boa' },
  'praia-da-rainha': { year: 2025, waterQuality: 'excelente' },
  'praia-da-vieira': { year: 2025, waterQuality: 'excelente' },
  'sines': { year: 2025, waterQuality: 'boa' },
  'esposende-praia': { year: 2025, waterQuality: 'excelente' },
  'obidos-lagoon-sul': { year: 2025, waterQuality: 'excelente' },
  'obidos-lagoon-foz': { year: 2025, waterQuality: 'excelente' },
