...
export const translations = {
  pt: {
    ...
    spotDetail: {
      ...
      seaStateHint: 'Radar: setas apontam de onde vem o vento/ondulação. Tabela: feixe dominante (★) com mais energia.',
  ...
  en: {
    ...
    spotDetail: {
      ...
      seaStateHint: 'Radar: arrows show where wind/swell come from. Table: dominant train (★) carries most energy.',
