...
export const translations = {
  pt: {
    ...
    spotDetail: {
      ...
      seaStateHint: 'Mapa terra/mar para o vento · radar de ondulação · tabela com feixe dominante (★).',
      windContextTitle: 'Como ler o vento',
      windShoreTitle: 'Vento na costa',
      windShoreSea: 'MAR',
      windShoreLand: 'TERRA',
      windShoreFrom: 'de',
      windShoreCoastFacing: 'Costa voltada a',
  ...
  en: {
    ...
    spotDetail: {
      ...
      seaStateHint: 'Land/sea map for wind · swell radar · table with dominant train (★).',
      windContextTitle: 'Reading wind',
      windShoreTitle: 'Wind at the coast',
      windShoreSea: 'SEA',
      windShoreLand: 'LAND',
      windShoreFrom: 'from',
      windShoreCoastFacing: 'Coast facing',
