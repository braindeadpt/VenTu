...
export const spots: Spot[] = [
  ...
  {
      id: 'esposende-praia', slug: 'esposende-praia', name: 'Esposende Praia (Oceano)', nameEn: 'Esposende Ocean Beach',
      region: 'Esposende', regionEn: 'Esposende', lat: 41.537, lon: -8.789,
      coastOrientation: 270,
      type: 'kitesurf', difficulty: 'intermediate', bestWind: 'NW, N', bestSwell: 'W, NW',
      description: 'Lado oceano de Esposende — kite e surf com Nortada quando a lagoa do Cávado está cheia de crowd. Complementa o spot da lagoa (esposende). Praia ampla; escolas de kite na vila.',
      descriptionEn: 'Ocean side of Esposende — kite and surf with Nortada when the Cavado lagoon is crowded. Complements the lagoon spot (esposende). Wide beach; kite schools in town.',
      compatibleSports: ['kitesurf', 'surf', 'bodyboard', 'windsurf'],
      facilities: ['Estacionamento', 'Escolas kite', 'Restaurantes', 'WC'],
      hazards: ['Correntes', 'Multidão de verão'],
      localTips: {
        bestTide: 'Maré média — mais espaço entre banhistas e kite',
        bestTideEn: 'Mid tide — more space between swimmers and kite',
        parking: 'Parque junto à praia oceânica; lagoa a 5 min a pé.',
        parkingEn: 'Lot by the ocean beach; lagoon 5 min walk.',
        accommodation: 'Esposende e Ofir — hotéis e apartamentos para kitetrip norte.',
        accommodationEn: 'Esposende and Ofir — hotels and apartments for northern kitetrips.',
        localRule: 'Se a lagoa estiver flat e vazia, preferir esposende; oceano para ondas e vento mais limpo.',
        localRuleEn: 'If the lagoon is flat and empty, prefer esposende; ocean for waves and cleaner wind.',
      }
    },
  {
    ...
    },
  {
      ...
      region: 'Ovar', regionEn: 'Ovar', lat: 40.878, lon: -8.660,
      coastOrientation: 270,
      type: 'kitesurf', difficulty: 'intermediate', bestWind: 'NW, N', bestSwell: 'W, NW',
      description: 'Praia extensa entre Maceda e Espinho — referência de kite no norte com Nortada de verão. Beach break consistente para surf; na maré baixa há espaço amplo para lançamento. Menos crowd que Espinho no pico de kite.',
      descriptionEn: 'Long beach between Maceda and Espinho — northern kite reference with summer Nortada. Consistent beach break for surf; low tide gives wide launch space. Less kite crowd than Espinho.',
  ...
  {
      id: 'praia-da-vieira', slug: 'praia-da-vieira', name: 'Praia da Vieira', nameEn: 'Vieira Beach',
      region: 'Marinha Grande', regionEn: 'Marinha Grande', lat: 39.872, lon: -8.970,
      coastOrientation: 270,
      type: 'kitesurf', difficulty: 'intermediate', bestWind: 'NW, N', bestSwell: 'W, NW',
      description: 'Praia longa entre Leiria e Figueira da Foz com Nortada de verão. Kitesurf em freeride com ondulação moderada; surf e bodyboard em swell. Vila da Vieira da Beira Nova com alojamento e restauração a poucos minutos — útil em kitetrip pela costa centro.',
      descriptionEn: 'Long beach between Leiria and Figueira da Foz with summer Nortada. Kitesurf freeride with moderate swell; surf and bodyboard on swell days. Vieira da Beira Nova village with accommodation and food minutes away — handy on a central coast kitetrip.',
      compatibleSports: ['kitesurf', 'surf', 'bodyboard'],
      facilities: ['Estacionamento', 'Restaurantes', 'Alojamento', 'WC'],
      hazards: ['Correntes', 'Multidão de verão na zona balnear'],
      localTips: {
        bestTide: 'Maré média — mais espaço na areia para kite',
        bestTideEn: 'Mid tide — more beach space for kite',
        parking: 'Parques junto à praia e na vila. No verão chega cedo aos fins de semana.',
        parkingEn: 'Lots by the beach and in the village. In summer arrive early on weekends.',
        accommodation: 'Vieira da Beira Nova e Marinha Grande — hotéis e apartamentos a 5–10 min.',
        accommodationEn: 'Vieira da Beira Nova and Marinha Grande — hotels and apartments 5–10 min away.',
        food: 'Restaurantes na marginal da Vieira — peixe e marisco após a sessão.',
        foodEn: 'Waterfront restaurants in Vieira — fish and seafood after the session.',
        localRule: 'Respeita as zonas de banhistas no verão — kite mais para norte/sul da praia principal.',
        localRuleEn: 'Respect swimmer zones in summer — kite more to the north/south of the main beach.',
      }
    },
  {
  ...
  {
      id: 'obidos-lagoon-sul', slug: 'obidos-lagoon-sul', name: 'Lagoa de Óbidos — Sul', nameEn: 'Obidos Lagoon — South',
      region: 'Óbidos', regionEn: 'Obidos', lat: 39.427, lon: -9.232,
      coastOrientation: 270,
      type: 'kitesurf', difficulty: 'beginner', bestWind: 'NW, N', bestSwell: 'Lagoa',
      description: 'Zona sul da lagoa, junto à Foz do Arelho — água plana e rasa para kite e foil. Crowd das escolas concentrada aqui no verão; maré média-alta dá mais profundidade. Pin separado para kitetrip (vs. centro da lagoa e foz).',
      descriptionEn: 'South lagoon zone by Foz do Arelho — flat shallow water for kite and foil. School crowd concentrates here in summer; mid-high tide adds depth. Separate pin for kitetrips (vs. lagoon centre and mouth).',
      compatibleSports: ['kitesurf', 'foil', 'windsurf', 'sup'],
      conditionsSource: 'obidos-lagoon',
      facilities: ['Estacionamento', 'Escolas kite', 'Aluguer', 'WC', 'Restaurantes'],
      hazards: ['Multidão de iniciantes', 'Conchas no fundo', 'Maré baixa'],
      localTips: {
        bestTide: 'Maré média-alta — evita bancos de areia',
        bestTideEn: 'Mid-high tide — avoids sandbanks',
        parking: 'Parques junto à Foz do Arelho e marginal sul da lagoa.',
        parkingEn: 'Lots by Foz do Arelho and the south lagoon waterfront.',
        accommodation: 'Foz do Arelho e Caldas da Rainha — apartamentos a 5–15 min.',
        accommodationEn: 'Foz do Arelho and Caldas da Rainha — apartments 5–15 min away.',
        food: 'Restaurantes na Foz do Arelho com vista para a lagoa.',
        foodEn: 'Foz do Arelho restaurants with lagoon views.',
        localRule: 'Mais crowd que o centro da lagoa — respeita zonas de escola e downwinders.',
        localRuleEn: 'More crowded than the lagoon centre — respect school zones and downwinders.',
      }
    },
  {
      id: 'obidos-lagoon-foz', slug: 'obidos-lagoon-foz', name: 'Lagoa de Óbidos — Foz', nameEn: 'Obidos Lagoon — Mouth',
      region: 'Óbidos', regionEn: 'Obidos', lat: 39.429, lon: -9.225,
      coastOrientation: 270,
      type: 'kitesurf', difficulty: 'intermediate', bestWind: 'NW, N', bestSwell: 'Lagoa / Oceano',
      description: 'Foz da lagoa com vento venturi amplificado — freeride com mais espaço que o sul em dias bons. Corrente possível para a praia oceânica; intermediários e avançados. Menos escolas que a zona sul.',
      descriptionEn: 'Lagoon mouth with amplified venturi wind — freeride with more space than the south on good days. Possible current toward the ocean beach; intermediates and advanced. Fewer schools than the south zone.',
      compatibleSports: ['kitesurf', 'foil', 'windsurf'],
      conditionsSource: 'obidos-lagoon',
      facilities: ['Estacionamento', 'Escolas kite', 'WC'],
      hazards: ['Corrente na foz', 'Rochas na praia oceânica adjacente', 'Vento irregular junto à foz'],
      localTips: {
        bestTide: 'Maré média — equilíbrio entre profundidade e espaço',
        bestTideEn: 'Mid tide — balance of depth and space',
        parking: 'Estacionamento na Foz do Arelho; caminho curto até à foz da lagoa.',
        parkingEn: 'Parking at Foz do Arelho; short walk to the lagoon mouth.',
        accommodation: 'Foz do Arelho — alojamento na vila; Óbidos a 15 min.',
        accommodationEn: 'Foz do Arelho village lodging; Obidos 15 min.',
        localRule: 'Não confundir com a praia oceânica (foz-arelho-beach) — este pin é a foz da lagoa.',
        localRuleEn: 'Not the ocean beach (foz-arelho-beach) — this pin is the lagoon mouth.',
      }
    },
  {
    ...
    },
  {
      ...
      description: 'Estuário do Tejo com água plana — referência de kite, windsurf e foil na margem sul de Lisboa. Inclui zona Alcochete/Seixal. Crowd de kite concentrada aos fins de semana de vento; ideal para kitetrip urbano com Lisboa a 20 min.',
      descriptionEn: 'Tagus estuary flat water — reference kite, windsurf and foil spot on the south bank of Lisbon. Includes Alcochete/Seixal area. Kite crowd peaks on windy weekends; ideal urban kitetrip with Lisbon 20 min away.',
      compatibleSports: ['kitesurf', 'windsurf', 'foil'],
      facilities: ['Estacionamento', 'Escola kite'],
      hazards: ['Tráfego de barcos', 'Maré', 'Corrente do Tejo'],
      localTips: {
        bestTide: 'Maré média-alta — mais profundidade na baía',
        bestTideEn: 'Mid-high tide — more depth in the bay',
        parking: 'Parques em Seixal e Alcochete junto ao cais.',
        parkingEn: 'Lots in Seixal and Alcochete near the pier.',
        accommodation: 'Lisboa, Almada e Seixal — apartamentos para kiters com carro.',
        accommodationEn: 'Lisbon, Almada and Seixal — apartments for kiters with a car.',
        localRule: 'Dá prioridade a barcos e pesca — água plana mas tráfego real.',
        localRuleEn: 'Give way to boats and fishing — flat water but real traffic.',
      }
    },
  {
    ...
    },
  {
      ...
      coastOrientation: 270,
      type: 'multisport', difficulty: 'intermediate', bestWind: 'NW, N', bestSwell: 'W, NW',
      description: 'Um dos picos mais consistentes da Costa da Caparica — surf de qualidade e kite com Nortada fora da época balnear. Multidão de surfistas de Lisboa; crowd de kite moderada comparada com Fonte da Telha.',
      descriptionEn: 'One of the most consistent peaks at Costa da Caparica — quality surf and kite with Nortada outside bathing season. Crowded with Lisbon surfers; moderate kite crowd compared to Fonte da Telha.',
      facilities: ['Estacionamento', 'Escola surf', 'Escola kite', 'Restaurante', 'WC'],
      hazards: ['Correntes', 'Multidão', 'Restrições de kite no verão (época balnear)'],
      compatibleSports: ['surf', 'bodyboard', 'kitesurf']
    },
  {
      id: 'sao-joao-caparica', slug: 'sao-joao-caparica', name: 'São João da Caparica', nameEn: 'Sao Joao da Caparica',
      region: 'Costa da Caparica', regionEn: 'Costa da Caparica', lat: 38.658, lon: -9.252,
      coastOrientation: 270,
      type: 'multisport', difficulty: 'beginner', bestWind: 'NW, N', bestSwell: 'W, NW',
      description: 'Praia tranquila da Caparica — ondas suaves para aprender surf e kite com Nortada fora do verão. Menos crowd que CDS/Rainha. Escolas de surf e kite na marginal.',
      descriptionEn: 'Quieter Caparica beach — gentle waves for learning surf and kite with Nortada outside summer. Less crowded than CDS/Rainha. Surf and kite schools on the waterfront.',
      facilities: ['Estacionamento', 'Escola surf', 'Escola kite', 'Restaurantes', 'WC'],
      hazards: ['Correntes moderadas', 'Restrições de kite na época balnear'],
      compatibleSports: ['surf', 'bodyboard', 'sup', 'kitesurf'],
      blueFlag: true
    },
  {
      id: 'costa-caparica', slug: 'costa-caparica', name: 'Costa da Caparica (CDS)', nameEn: 'Costa da Caparica (CDS)',
      region: 'Almada', regionEn: 'Almada', lat: 38.645, lon: -9.236,
      coastOrientation: 270,
      type: 'multisport', difficulty: 'beginner', bestWind: 'NW, N', bestSwell: 'W, SW',
      description: 'Praia central da Caparica (CDS, Dragão Vermelho). Beach breaks para aprender; kite possível com Nortada fora da época balnear. A 20 min de Lisboa — muito crowd de surf no fim de semana.',
      descriptionEn: 'Central Caparica beach (CDS, Dragão Vermelho). Beach breaks for learning; kite possible with Nortada outside bathing season. 20 min from Lisbon — very crowded with surfers on weekends.',
      compatibleSports: ['surf', 'bodyboard', 'kitesurf'],
      facilities: ['Estacionamento', 'Escolas surf', 'Escola kite', 'Restaurantes', 'WC'],
      hazards: ['Correntes em alguns picos', 'Multidão extrema no verão', 'Kite restrito na época balnear']
    },
  {
      ...
      coastOrientation: 270,
      type: 'kitesurf', difficulty: 'beginner', bestWind: 'NW, N', bestSwell: 'SW',
      description: 'Referência de kite na margem sul — Nortada térmica de verão, pouca multidão face à Caparica central. Ondas pequenas; ideal para iniciantes e freeride. Escola de kite na praia.',
      descriptionEn: 'South bank kite reference — summer thermal Nortada, far less crowded than central Caparica. Small waves; ideal for beginners and freeride. Kite school on the beach.',
      compatibleSports: ['kitesurf'],
      facilities: ['Estacionamento', 'Escola kite', 'WC'],
      hazards: ['Falésias no fundo — vento sideshore', 'Corrente em maré viva'],
      localTips: {
        bestTide: 'Maré média-alta — mais profundidade junto às falésias',
        bestTideEn: 'Mid-high tide — more depth near the cliffs',
        parking: 'Parque junto à praia; gratuito fora do verão. Chega cedo aos sábados de vento.',
        parkingEn: 'Lot by the beach; free outside summer. Arrive early on windy Saturdays.',
        food: 'Bares na marginal de Fonte da Telha; Almada a 15 min para mais opções.',
        foodEn: 'Bars on Fonte da Telha waterfront; Almada 15 min for more options.',
        localRule: 'Spot menos crowd que CDS — ainda assim respeita banhistas e zonas de escola.',
        localRuleEn: 'Less crowded than CDS — still respect swimmers and school zones.',
      }
    },
  {
      id: 'ponta-dos-corvos', slug: 'ponta-dos-corvos', name: 'Ponta dos Corvos', nameEn: 'Ponta dos Corvos',
      region: 'Seixal', regionEn: 'Seixal', lat: 38.651, lon: -9.104,
      coastOrientation: 225,
      type: 'kitesurf', difficulty: 'intermediate', bestWind: 'NW, N', bestSwell: 'Tejo / SW',
      description: 'Spot de kite na margem sul do Tejo, a sul da Caparica. Água mais abrigada que o oceano aberto — freeride e foil com Nortada. Pouco crowd; acesso por estradas da costa seixalense.',
      descriptionEn: 'Kite spot on the south Tagus bank, south of Caparica. More sheltered water than open ocean — freeride and foil with Nortada. Low crowd; access via Seixal coastal roads.',
      compatibleSports: ['kitesurf', 'foil'],
      facilities: ['Estacionamento'],
      hazards: ['Correntes do Tejo', 'Rochas em maré baixa', 'Menos infraestrutura que Caparica'],
      localTips: {
        bestTide: 'Maré alta — mais água e menos rochas',
        bestTideEn: 'High tide — more water and fewer rocks',
        parking: 'Estacionamento limitado na zona da ponta — chega cedo em dias de vento.',
        parkingEn: 'Limited parking at the point — arrive early on windy days.',
        accommodation: 'Seixal e Costa da Caparica a 10–20 min; Lisboa a 30 min.',
        accommodationEn: 'Seixal and Costa da Caparica 10–20 min; Lisbon 30 min.',
        localRule: 'Spot de locals e kiters experientes — evita lançar em frente a pescadores.',
        localRuleEn: 'Local and experienced kiter spot — avoid launching in front of fishermen.',
      }
    },
  {
      id: 'trafaria', slug: 'trafaria', name: 'Trafaria Kitebeach', nameEn: 'Trafaria Kitebeach',
      region: 'Almada', regionEn: 'Almada', lat: 38.671, lon: -9.243,
      coastOrientation: 270,
      type: 'kitesurf', difficulty: 'intermediate', bestWind: 'NW, N', bestSwell: 'SW',
      description: 'Praia em frente a Belém, do lado sul do Tejo. Kite com Nortada e vista para Lisboa. Ferry de Belém para Trafaria. Crowd de kite moderada; muito procurada em tardes térmicas de verão.',
      descriptionEn: 'Beach facing Belém on the south bank of the Tagus. Kite with Nortada and Lisbon skyline views. Ferry from Belém to Trafaria. Moderate kite crowd; popular on summer thermal afternoons.',
      compatibleSports: ['kitesurf', 'foil'],
      facilities: ['Estacionamento', 'Ferry', 'Restaurantes', 'Escola kite'],
      hazards: ['Corrente na foz do Tejo', 'Tráfego marítimo', 'Restrições na época balnear'],
      localTips: {
        bestTide: 'Maré média-alta',
        bestTideEn: 'Mid-high tide',
        parking: 'Rua estreita junto à praia — estacionamento disputado ao fim de semana.',
        parkingEn: 'Narrow street by the beach — contested parking on weekends.',
        food: 'Restaurantes de peixe na Trafaria; Belém a 10 min de ferry.',
        foodEn: 'Fish restaurants in Trafaria; Belém 10 min by ferry.',
        localRule: 'Respeita a fila de ferry e os pescadores no cais.',
        localRuleEn: 'Respect the ferry queue and fishermen on the pier.',
      }
    },
  {
      id: 'cova-do-vapor', slug: 'cova-do-vapor', name: 'Cova do Vapor', nameEn: 'Cova do Vapor',
      region: 'Almada', regionEn: 'Almada', lat: 38.665, lon: -9.267,
      coastOrientation: 270,
      type: 'kitesurf', difficulty: 'intermediate', bestWind: 'NW, N', bestSwell: 'SW',
      description: 'Aldeia piscatória e praia selvagem a sul da Caparica. Kite com Nortada num ambiente mais autêntico e menos turístico. Menos crowd que Nova Vaga ou CDS.',
      descriptionEn: 'Fishing village and wild beach south of Caparica. Kite with Nortada in a more authentic, less touristy setting. Less crowded than Nova Vaga or CDS.',
      compatibleSports: ['kitesurf'],
      facilities: ['Estacionamento'],
      hazards: ['Correntes', 'Acesso estreito', 'Sem escola de kite na praia'],
      localTips: {
        bestTide: 'Maré média',
        bestTideEn: 'Mid tide',
        parking: 'Parque pequeno na aldeia — lota rápido em dias de vento.',
        parkingEn: 'Small village lot — fills fast on windy days.',
        food: 'Tasca na Cova do Vapor; Caparica a 5 min de carro.',
        foodEn: 'Local tavern in Cova do Vapor; Caparica 5 min drive.',
        localRule: 'Aldeia de pescadores — não bloqueies acesso ao cais.',
        localRuleEn: 'Fishing village — do not block pier access.',
      }
    },
  {
      id: 'praia-da-rainha', slug: 'praia-da-rainha', name: 'Praia da Rainha', nameEn: 'Rainha Beach',
      region: 'Costa da Caparica', regionEn: 'Costa da Caparica', lat: 38.636, lon: -9.232,
      coastOrientation: 270,
      type: 'kitesurf', difficulty: 'beginner', bestWind: 'NW, N', bestSwell: 'W, NW',
      description: 'Secção sul da Costa da Caparica, junto à Rainha. Ondas suaves e espaço para kite iniciante com Nortada. Mais calma que CDS; boa para quem aprende após Fonte da Telha.',
      descriptionEn: 'South section of Costa da Caparica, near Rainha. Gentle waves and space for beginner kite with Nortada. Calmer than CDS; good for learning after Fonte da Telha.',
      compatibleSports: ['kitesurf', 'surf', 'bodyboard'],
      facilities: ['Estacionamento', 'Restaurantes', 'WC'],
      hazards: ['Correntes', 'Multidão de verão', 'Kite restrito na época balnear'],
      localTips: {
        bestTide: 'Maré baixa a média',
        bestTideEn: 'Low to mid tide',
        parking: 'Estacionamento na marginal da Rainha.',
        parkingEn: 'Parking on the Rainha waterfront.',
        accommodation: 'Hotéis e apartamentos na Costa da Caparica — base comum para kitetrip em Lisboa.',
        accommodationEn: 'Hotels and apartments on Costa da Caparica — common base for Lisbon kitetrips.',
        localRule: 'Menos crowd de kite que CDS — mantém distância das escolas de surf.',
        localRuleEn: 'Less kite crowd than CDS — keep clear of surf schools.',
      }
    },
  {
  ...
  {
      id: 'troia', slug: 'troia', name: 'Tróia (Península do Sado)', nameEn: 'Troia (Sado Peninsula)',
      region: 'Grândola', regionEn: 'Grandola', lat: 38.496, lon: -8.892,
      coastOrientation: 200,
      type: 'kitesurf', difficulty: 'intermediate', bestWind: 'S, SW, W', bestSwell: 'Lagoa / Oceano',
      description: 'Península entre o Sado e o Atlântico — spot duplo: água plana no estuário (Bico das Lulas) e ondas médias no oceano. Vento mais estável de S/SW; Nortada pode ser gusty. Ferry de Setúbal. Reserva natural com golfinhos do Sado.',
      descriptionEn: 'Peninsula between the Sado and Atlantic — dual spot: flat water in the estuary (Bico das Lulas) and medium waves on the ocean side. More stable S/SW wind; Nortada can be gusty. Ferry from Setúbal. Nature reserve with Sado dolphins.',
      compatibleSports: ['kitesurf', 'foil'],
      facilities: ['Estacionamento', 'Ferry Setúbal', 'Escola kite', 'Restaurantes', 'Alojamento', 'WC'],
      hazards: ['Corrente na foz do Sado', 'Nortada irregular', 'Zonas de proteção da reserva'],
      blueFlag: true,
      localTips: {
        bestTide: 'Maré média no estuário — evita maré muito baixa nas bancas de areia',
        bestTideEn: 'Mid tide in the estuary — avoid very low tide on sandbanks',
        parking: 'Parques junto às praias do resort e Bico das Lulas. Ferry Setúbal–Tróia a cada hora.',
        parkingEn: 'Lots by resort beaches and Bico das Lulas. Setúbal–Troia ferry hourly.',
        accommodation: 'Resort Tróia, Comporta e Setúbal — base ideal para kitetrip no Sado.',
        accommodationEn: 'Troia resort, Comporta and Setúbal — ideal base for a Sado kitetrip.',
        food: 'Restaurantes no resort Tróia; peixe fresco em Comporta a 15 min.',
        foodEn: 'Restaurants at Troia resort; fresh fish in Comporta 15 min away.',
        localRule: 'Lado Sado para flat e aprendizagem; lado oceano para ondas. Respeita golfinhos e zonas vedadas.',
        localRuleEn: 'Sado side for flat water and learning; ocean side for waves. Respect dolphins and restricted zones.',
      }
    },
  {
      id: 'comporta', slug: 'comporta', name: 'Comporta', nameEn: 'Comporta',
      region: 'Grândola', regionEn: 'Grandola', lat: 38.380, lon: -8.785,
      coastOrientation: 270,
      type: 'kitesurf', difficulty: 'beginner', bestWind: 'NW, N', bestSwell: 'SW, W',
      description: 'Praia extensa de areia branca no Alentejo litoral. Freeride e light-wind com Nortada; ondulação só com swell forte. Menos crowd de kite que Tróia no pico de verão. Vila com alojamento boutique — paragem clássica em kitetrip sul de Lisboa.',
      descriptionEn: 'Long white sand beach on the Alentejo coast. Freeride and light-wind with Nortada; swell only on strong days. Less kite crowd than Troia at summer peak. Village with boutique lodging — classic stop on a south-Lisbon kitetrip.',
      compatibleSports: ['kitesurf', 'foil'],
      facilities: ['Estacionamento', 'Restaurantes', 'Alojamento', 'WC'],
      hazards: ['Correntes com swell', 'Multidão de verão na vila (não na praia)'],
      localTips: {
        bestTide: 'Qualquer maré — praia extensa',
        bestTideEn: 'Any tide — long beach',
        parking: 'Acesso por pinhal — segue sinalização para a praia. Estacionamento na areia em época baixa.',
        parkingEn: 'Access through pine forest — follow beach signs. Sand parking in off-season.',
        accommodation: 'Comporta, Carvalhal e Melides — casas e hotéis de charme a 5–15 min.',
        accommodationEn: 'Comporta, Carvalhal and Melides — charming houses and hotels 5–15 min.',
        food: 'Comporta Café, Cavalariça e restaurantes na vila.',
        foodEn: 'Comporta Café, Cavalariça and village restaurants.',
        localRule: 'Spot de light-wind — leva equipamento grande ou foil para dias fracos.',
        localRuleEn: 'Light-wind spot — bring big gear or foil for weak days.',
      }
    },
  {
      id: 'carvalhal-comporta', slug: 'carvalhal-comporta', name: 'Carvalhal / Comporta', nameEn: 'Carvalhal / Comporta',
      region: 'Grândola', regionEn: 'Grandola', lat: 38.262, lon: -8.772,
      coastOrientation: 270,
      type: 'kitesurf', difficulty: 'beginner', bestWind: 'NW, N', bestSwell: 'SW',
      description: 'Praia do Carvalhal no pinhal do Sado — kite com Nortada em freeride, a sul de Comporta. Quase sem crowd face a Tróia ou Caparica. Não confundir com Carvalhal na Costa Vicentina (slug carvalhal).',
      descriptionEn: 'Carvalhal beach in the Sado pine forest — Nortada kite freeride, south of Comporta. Almost no crowd compared to Troia or Caparica. Not to be confused with Carvalhal on the Vicentina Coast (slug carvalhal).',
      compatibleSports: ['kitesurf', 'foil', 'surf', 'bodyboard'],
      facilities: ['Estacionamento'],
      hazards: ['Sem infraestrutura', 'Correntes com swell', 'Acesso por estrada de pinhal'],
      localTips: {
        bestTide: 'Maré baixa a média — mais areia para lançamento',
        bestTideEn: 'Low to mid tide — more sand for launch',
        parking: 'Parque no fim da estrada do Carvalhal — gratuito.',
        parkingEn: 'Lot at the end of Carvalhal road — free.',
        accommodation: 'Casas no pinhal do Carvalhal e Comporta a 10 min.',
        accommodationEn: 'Houses in Carvalhal pines and Comporta 10 min away.',
        localRule: 'Carvalhal do Sado — ver também Comporta e Tróia no mesmo kitetrip.',
        localRuleEn: 'Sado Carvalhal — see also Comporta and Troia on the same kitetrip.',
      }
    },
  {
  ...
  {
      id: 'sines', slug: 'sines', name: 'Sines', nameEn: 'Sines',
      region: 'Sines', regionEn: 'Sines', lat: 37.955, lon: -8.869,
      coastOrientation: 270,
      type: 'kitesurf', difficulty: 'advanced', bestWind: 'NW, N', bestSwell: 'W, SW',
      description: 'Praia urbana junto ao porto de Sines. Kite com Nortada e ondulação em swell — lançamento com atenção a rochas. Spot distinto de São Torpes (7 km). Menos crowd de kite; infraestrutura urbana para alojamento e reparações.',
      descriptionEn: 'Urban beach by Sines port. Kite with Nortada and swell waves — launch carefully around rocks. Distinct from Sao Torpes (7 km). Low kite crowd; town infrastructure for lodging and repairs.',
      compatibleSports: ['kitesurf', 'surf', 'bodyboard'],
      facilities: ['Estacionamento', 'Restaurantes', 'Alojamento', 'WC'],
      hazards: ['Rochas no lançamento', 'Correntes', 'Vento gusty junto ao porto'],
      localTips: {
        bestTide: 'Maré alta — mais água sobre as rochas',
        bestTideEn: 'High tide — more water over the rocks',
        parking: 'Estacionamento na praia de Vasco da Gama e zona portuária.',
        parkingEn: 'Parking at Vasco da Gama beach and port area.',
        accommodation: 'Sines centro — hotéis e guesthouses a 5 min da praia.',
        accommodationEn: 'Sines town centre — hotels and guesthouses 5 min from the beach.',
        food: 'Restaurantes no centro histórico e na marginal.',
        foodEn: 'Restaurants in the historic centre and waterfront.',
        localRule: 'Inspeciona o lançamento em cada maré — fundo muda com as obras do porto.',
        localRuleEn: 'Inspect the launch each tide — bottom changes with port works.',
      }
    },
  {
  ...
  {
      id: 'carvalhal', slug: 'carvalhal', name: 'Carvalhal', nameEn: 'Carvalhal (Vicentina Coast)',
      region: 'Alentejo', regionEn: 'Alentejo', lat: 37.500, lon: -8.792,
      coastOrientation: 270,
      type: 'surf', difficulty: 'intermediate', bestWind: 'E, NE', bestSwell: 'W, NW',
      description: 'Praia selvagem na Costa Vicentina. Surf, bodyboard e SUP consistentes. Para kite ver Carvalhal/Comporta e Tróia a norte (slug carvalhal-comporta).',
      descriptionEn: 'Wild beach on the Vicentina Coast. Consistent surf, bodyboard and SUP. For kite see Carvalhal/Comporta and Troia to the north (slug carvalhal-comporta).',
      compatibleSports: ['surf', 'bodyboard', 'sup'],
      facilities: ['Estacionamento'],
      hazards: ['Correntes']
    },
