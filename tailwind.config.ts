  ...
  theme: {
    extend: {
      colors: {
        ...
        // RGB-only in CSS vars — always set opacity: bg-surface-1/[0.04], bg-surface-2/[0.08], bg-surface-3/[0.12]
        surface: {
      ...
      fontSize: {
        ...
        'meta-xs':    ['0.625rem',{ lineHeight: '1.4', letterSpacing: '0.05em',  fontWeight: '500' }],
