...
export default defineConfig({
  test: {
    ...
    include: [
      ...
      'scripts/lib/__tests__/sanitizeText.test.js',
      ...
      'scripts/lib/__tests__/deploySource.test.js',
      ...
      'scripts/lib/__tests__/evaluateAlertsPagination.test.js',
      ...
      'scripts/lib/__tests__/validateNewsLivecams.test.js',
